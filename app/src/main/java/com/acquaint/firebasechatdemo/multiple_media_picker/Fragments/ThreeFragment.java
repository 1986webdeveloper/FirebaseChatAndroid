package com.acquaint.firebasechatdemo.multiple_media_picker.Fragments;
...
import com.acquaint.firebasechatdemo.multiple_media_picker.Adapters.BucketsAdapter;
import com.acquaint.firebasechatdemo.multiple_media_picker.OpenGallery;
       ...
       /* Cursor cursor = getContext().getContentResolver()
                .query(MediaStore.Files.getContentUri("external"), projection2,
                        MediaStore.Files.FileColumns.MEDIA_TYPE + "="
                                + MediaStore.Files.FileColumns.MEDIA_TYPE_NONE,new String[]{bucket}, MediaStore.Files.FileColumns.DATE_ADDED);*/
